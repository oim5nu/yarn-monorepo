            ...
            ju(l)
                ...
                : l != null &&
                  (Bo(l) &&
                      (l = pc(
                          l,
                          t + (!l.key || (u && u.key === l.key) ? '' : ('' + l.key).replace(Iu, '$&/') + '/') + e
                      )),
                  n.push(l)),
            1
        );
...
var ie = { current: null },
    gr = { transition: null },
    hc = { ReactCurrentDispatcher: ie, ReactCurrentBatchConfig: gr, ReactCurrentOwner: Ao };
L.Children = {
    map: er,
...
var Xe = xc.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,
...
function Fc(e, n, t, r, l, o, u, i, s) {
    (Et = !1), (Tr = null), jc.apply(Ic, arguments);
}
...
function dt(e, n) {
    e.blockedOn === n &&
        ((e.blockedOn = null), ao || ((ao = !0), ye.unstable_scheduleCallback(ye.unstable_NormalPriority, bc)));
}
function jt(e) {
    function n(l) {
        return dt(l, e);
...
function bo(e, n, t, r) {
    if (Dr) {
        ...
        if (l === null) Dl(e, n, r, jr, t), Yu(e, r);
            ...
            for (; l !== null; ) {
                var o = Zt(l);
                if ((o !== null && Ns(o), (o = co(e, n, t, r)), o === null && Dl(e, n, r, jr, t), o === l)) break;
                l = o;
            }
...
function zf(e, n) {
    if (jn)
        return e === 'compositionend' || (!ru && js(e, n)) ? ((e = Ms()), (Sr = eu = en = null), (jn = !1), e) : null;
    switch (e) {
        case 'paste':
            return null;
        case 'keypress':
...
function $s(e) {
    if (e.propertyName === 'value' && rl(It)) {
        var n = [];
        Fs(n, It, e, Go(e)), gs(Tf, n);
    }
}
function Of(e, n, t) {
    e === 'focusin' ? (ri(), (_t = n), (It = t), _t.attachEvent('onpropertychange', $s)) : e === 'focusout' && ri();
}
function Mf(e) {
            ...
            e: {
                ...
                if (
                    ...
                    if (
                        ...
                        (h = null),
                        Sn(v) === c &&
                            ((S = new S(f, a + 'enter', w, t, v)), (S.target = d), (S.relatedTarget = I), (h = S)),
                        (I = h),
                        g && w)
                    )
                        n: {
...
function mi(e, n, t) {
    ...
    t ? ((e = Zs(e, n, xn)), (r.__reactInternalMemoizedMergedChildContext = e), j(fe), j(re), M(re, e)) : j(fe),
        M(fe, t);
}
var Ve = null,
    ul = !1,
    ...
    if (F) {
        ...
        if (n) {
            ...
            if (!vi(e, n)) {
                ...
                n = on(t.nextSibling);
                var r = he;
                n && vi(e, n) ? bs(r, t) : ((e.flags = (e.flags & -4097) | 2), (F = !1), (he = e));
            }
        } else {
            if (So(e)) throw Error(y(418));
...
function na(e) {
    ...
    function s(f, a, d, h) {
        ...
        return E === Dn
            ...
            : a !== null &&
                (a.elementType === E || (typeof E == 'object' && E !== null && E.$$typeof === Ze && yi(E) === a.type))
    ...
    function m(f, a, d) {
        ...
        if (typeof a == 'object' && a !== null) {
            switch (a.$$typeof) {
                case nr:
                    return (
                        (d = zr(a.type, a.key, a.props, null, f.mode, d)), (d.ref = mt(f, null, a)), (d.return = f), d
                    );
                case Mn:
    ...
    if (o !== null) {
        ...
        do {
            ...
            if ((r & p) === p) {
                v !== null &&
                    (v = v.next =
                        { eventTime: g, lane: 0, tag: i.tag, payload: i.payload, callback: i.callback, next: null });
                e: {
                    var w = e,
                        S = i;
...
function yu(e, n, t, r, l, o) {
    if (
        ...
        do {
            ...
            (o += 1), (G = K = null), (n.updateQueue = null), (Cr.current = rd), (e = t(r, l));
        } while (Pt);
    }
...
var Yr = {
    ...
    nd = {
        ...
        useTransition: function () {
            var e = Si(!1),
                n = e[0];
            return (e = qf.bind(null, e[1])), (je().memoizedState = e), [n, e];
        },
...
function Li(e, n, t, r, l) {
    ...
    if ((Gn(n, l), n.stateNode === null)) xr(e, n), xa(n, t, r), _o(n, t, r, l), (r = !0);
    else if (e === null) {
        var u = n.stateNode,
            i = n.memoizedProps;
        u.props = i;
...
function ud(e, n, t, r, l, o, u) {
    ...
    return l.data === '$?'
        ? ((n.flags |= 128), (n.child = e.child), (n = wd.bind(null, e)), (l._reactRetry = n), null)
        : ((e = o.treeContext),
          (ve = on(l.nextSibling)),
          (he = n),
          (F = !0),
...
function Fa(e) {
    ...
    n !== null && ((e.alternate = null), Fa(n)),
        ...
        (e.sibling = null),
        e.tag === 5 &&
            ((n = e.stateNode), n !== null && (delete n[Ie], delete n[Vt], delete n[go], delete n[Yf], delete n[Xf])),
        (e.stateNode = null),
        (e.return = null),
        (e.dependencies = null),
        ...
        case 5:
            ...
            if (r & 4 && ((l = e.stateNode), l != null)) {
                ...
                if (((e.updateQueue = null), s !== null))
                    try {
                        i === 'input' && o.type === 'radio' && o.name != null && ss(l, o), ro(i, u);
                        var c = ro(i, o);
...
function pe(e, n) {
    ...
    if (r === 0) t !== null && Ku(t), (e.callbackNode = null), (e.callbackPriority = 0);
        ...
        if ((t != null && Ku(t), n === 1))
            e.tag === 0 ? Gf(Ui.bind(null, e)) : Js(Ui.bind(null, e)),
                Qf(function () {
                    !(R & 6) && vn();
                }),
                (t = null);
...
function Qa(e) {
    ...
    (e.memoizedProps = e.pendingProps), n === null ? Ka(e) : (Q = n), (Eu.current = null);
}
function Ka(e) {
    var n = e;
    do {
...
function $i(e, n, t) {
    (n = tt(t, n)), (n = Pa(e, n, 1)), (e = un(e, n, 1)), (n = ue()), e !== null && (Xt(e, 1, n), pe(e, n));
}
function A(e, n, t) {
    if (e.tag === 3) $i(e, e, t);
    else
...
hs = xu;
ys = Ln;
var Nd = { usingClientEntryPoint: !1, Events: [Zt, Un, ol, ms, vs, xu] },
    ht = { findFiberByHostInstance: Sn, bundleType: 0, version: '18.3.0', rendererPackageName: 'react-dom' },
    zd = {
        ...
        findFiberByHostInstance: ht.findFiberByHostInstance || xd,
...
const Td = '/assets/react-CHdo91hT.svg',
    Rd = '/vite.svg';
function Od() {
        ...
        children: [
            le.jsxs('div', {
                children: [
                    le.jsx('a', {
                        ...
                        target: '_blank',
                        children: le.jsx('img', { src: Rd, className: 'logo', alt: 'Vite logo' })
                    }),
                    le.jsx('a', {
                        href: 'https://react.dev',
                        target: '_blank',
                        children: le.jsx('img', { src: Td, className: 'logo react', alt: 'React logo' })
                    })
                ]
            }),
            ...
            le.jsxs('div', {
                ...
                children: [
                    ...
                    le.jsxs('p', {
                        children: ['Edit ', le.jsx('code', { children: 'src/App.tsx' }), ' and save to test HMR']
                    })
                ]
            }),
...
Ql.createRoot(document.getElementById('root')).render(le.jsx(yc.StrictMode, { children: le.jsx(Od, {}) }));
